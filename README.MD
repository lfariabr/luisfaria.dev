...
- Running Goggins Mode, a focused motivational AI mini-product
...
- NextAuth.js for authentication (UI & flows)
...
- Frontend Components 
> *These are some of the reusable components that showcase UI architecture and state management:*
