...
**Tags**: `aws` `cloudcomputing` `devops` `softwareengineering`

---

# How I Designed a Scalable AWS Architecture for a Growing Startup (And Earned My Solutions Architect Certificate)
...
![Architecture Diagram Final](https://dev-to-uploads.s3.amazonaws.com/uploads/articles/xkphgis5mpyfxs0s2i6m.png)
...
What architectural challenges are you currently facing? Let's discuss!# How I Designed a Scalable AWS Architecture for a Growing Startup (And Earned My Solutions Architect Certificate)
