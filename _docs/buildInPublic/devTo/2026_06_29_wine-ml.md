...
**Tags:**  `machinelearning`  `python`  `datascience`  `showdev`  

> *Update (July 2026): the metrics below are from v1. Auditing this same pipeline for a university assessment, I found 1,177 exact duplicate rows leaking across my train/test split - the honest numbers are lower, and the story of finding them is [at the end of this post](#update-the-audit-that-ate-my-metrics).*
...
So I built **[sommelier-api](https://github.com/lfariabr/sommelier-api)**: one dataset, two questions, two surfaces.
...
![fig1-from-csv-to-saved-models](https://dev-to-uploads.s3.us-east-2.amazonaws.com/uploads/articles/n5dguoaliysnklbtd35k.png)
...
So [sommelier-api v0.1.0](https://github.com/lfariabr/sommelier-api/releases/tag/v0.1.0) deduplicates before the split (5,320 unique wines) and retrains. The honest numbers:
...
- **Dataset** — P. Cortez, A. Cerdeira, F. Almeida, T. Matos, J. Reis. *Modeling wine preferences by data mining from physicochemical properties.* Decision Support Systems 47(4), 547–553 (2009). [UCI Wine Quality](https://archive.ics.uci.edu/dataset/186/wine+quality).
- **Code** — [github.com/lfariabr/sommelier-api](https://github.com/lfariabr/sommelier-api):
