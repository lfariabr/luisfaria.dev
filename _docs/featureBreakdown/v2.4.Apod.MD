...
## Backlog
- ~~**Backend Integration**: Create GraphQL query to fetch/cache APOD from NASA API~~ ✅ Done
-  ~~**Authenticated Features**: Allow logged-in users to browse historical APODs~~ ✅ `getApodByDate`
- ~~**Timeout Handling**: Add request timeout + retry logic for slow NASA responses~~ ✅ Done
...
- ~~**Schema Compatibility**: Support NASA's `media_type: "other"`~~ ✅ Done
