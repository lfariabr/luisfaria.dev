...
## Issue XX: frontend: APOD rate limiter UI badge, disabled button, and countdown

[GraphQL error]: Message: Rate limit exceeded, Location: [{"line":2,"column":3}], Path: getApodByDate, Extensions: {"code":"RATE_LIMIT_EXCEEDED","limit":5,"remaining":0,"resetTime":"2026-01-19T18:06:18.487Z","stacktrace":["GraphQLError: Rate limit exceeded","    at applyRateLimit (/Users/luisfaria/Desktop/sEngineer/luisfaria/backend/src/utils/applyRateLimit.ts:27:15)","    at processTicksAndRejections (node:internal/process/task_queues:105:5)","    at async Object.getApodByDate (/Users/luisfaria/Desktop/sEngineer/luisfaria/backend/src/resolvers/apod/queries.ts:63:5)","    at async middleware (/Users/luisfaria/Desktop/sEngineer/luisfaria/backend/node_modules/graphql-shield/cjs/generator.js:30:24)"]}

src/lib/apollo/client.ts (12:17) @ eval


  10 |       console.group('GraphQL Errors:');
  11 |       graphQLErrors.forEach(({ message, locations, path, extensions }) => {
> 12 |         console.error(
     |                 ^
  13 |           `[GraphQL error]: Message: ${message}, Location: ${JSON.stringify(
  14 |             locations
  15 |           )}, Path: ${path}, Extensions: ${JSON.stringify(extensions)}`
