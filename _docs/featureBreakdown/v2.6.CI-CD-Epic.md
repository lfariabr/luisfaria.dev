...
Based on my setup, I have a solid Docker Compose deployment but a manual workflow (SSH → git pull → docker compose rebuild). This is an Epic that transforms this into a proper CI/CD pipeline.
...
### Issue 2: Docker Image Registry
- [ ] Set up GitHub Container Registry (GHCR)
- [ ] Add image build step to workflow
