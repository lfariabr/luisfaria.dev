...
- Implementation:
        ...
        - I EVEN CHANGED SOMETHING SIMPLE ON MY TIMELINE, ADDING 2026
        - THE NPM TEST FAILED AND DIDN'T GO THROUGH, BECAUSE 2026 WASN'T COVERED ON TDD, HAHAHAHA, THIS IS AWESOME
        - THEN I FIXED, COMMITED AGAIN, TEST AND CI FLOW WENT THROUGH... NOW IT IS LOADING, I'M POSITIVE IT IS GOING TO WORK
        - IT DIDN'T WORK, OH MY GOD... `502 Bad Gateway / nginx/1.29.5`
        - TRYING ADDING `--force-recreate` to `ci.yml`

TO BE DONE NEXT:
        - I added workflow_dispatch for manual testing
        - I pushed and tested
