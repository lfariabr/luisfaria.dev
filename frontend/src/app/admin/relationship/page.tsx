  ...
  return (
    <div className="space-y-4">
      <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
        <div>
          <h1 className="text-3xl font-bold tracking-tight">Our Sydney Adventures</h1>
          <p className="text-muted-foreground">Private admin map of places visited together this year</p>
        </div>
