      ...
      <div className="mx-auto max-w-6xl px-4 py-16">
        <div className="mb-10 text-center">
          ...
          <p className="mt-2 text-sm text-muted-foreground">
            Real, concrete results from systems I&apos;ve built, scaled, and run - where
            there&apos;s a public write-up, the number links to it.
          </p>
        </div>
              ...
              <div className="space-y-4">
                {group.stats.map((stat) =>
                  stat.href ? (
                    ...
                    >
                      <p className="text-3xl font-bold transition-colors group-hover:text-emerald-500">
                        {stat.value}
                      </p>
