...
## 12. APOD Feature - Client Analytics Events (Issue #64)

The APOD (Astronomy Picture of the Day) feature emits the following analytics events via `trackClientEvent()` (backed by Google Analytics `gtag`):
